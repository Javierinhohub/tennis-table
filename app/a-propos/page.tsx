  ...
  return (
    <main style={{ maxWidth: "720px", margin: "0 auto", padding: "2.5rem 2rem" }}>
      ...
      <div style={{ background: "#fff", border: "1px solid var(--border)", borderRadius: "12px", padding: "2rem", marginBottom: "1.5rem", lineHeight: 1.8, fontSize: "15px", color: "var(--text)" }}>
        <p>
          TT-Kip, c&apos;est l&apos;idée d&apos;un groupe de passionnés de ping, qui partagent depuis des années sur des forums. Parmi nous, des joueurs de picots longs, backside et picots courts dont un coach.
        </p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "2rem" }}>
        {[
          ...
          { titre: "Passionnés", desc: "Des joueurs de tous styles, niveau régional max (16-17)." },
          { titre: "Communauté", desc: "Le partage avant tout, sur le forum et les articles." },
          { titre: "Exhaustif", desc: "Plus de 1500 revêtements repertoriés, des centaines de bois." },
        ].map(c => (
