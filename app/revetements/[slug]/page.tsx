...
export default async function RevetementPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const { data: produit } = await supabase
    .from("produits")
    // NOTE: les colonnes note_ttk_* et note_marque_durabilite/rejet/qualite_prix/adherence/gene/inversion/globale
    // seront ajoutées ici après exécution du script supabase_revetements_optimisation.sql
